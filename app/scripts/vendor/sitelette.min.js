!function(){jQuery.fn.radiobutton=function(e){e=e||{};var a={className:"jquery-radiobutton",checkedClass:"jquery-radiobutton-on"},r=jQuery.extend(a,e||{});return this.each(function(){var e=$(this),a=jQuery('<div class="'+r.className+'-wrapper"><a class="'+r.className+'" href="#" name="'+e.attr("id")+'" rel="'+e.attr("name")+'"></a></div>'),t=jQuery("a",a);e.prop("checked")===!0&&t.addClass(r.checkedClass),t.on("click",function(e){e.preventDefault(),e.stopPropagation();var r=jQuery("input#"+jQuery(this).attr("name"),a.parent());return r.prop("checked")===!0?r.prop("checked",!1):r.prop("checked",!0),r.trigger("change"),!1}),e.on("change",function(e){var t=jQuery(this);jQuery('a[rel="'+t.attr("name")+'"].'+r.checkedClass).removeClass(r.checkedClass),t.prop("checked")===!0?jQuery("a[name="+t.attr("id")+"]",a.parent()).addClass(r.checkedClass):jQuery("a[name="+t.attr("id")+"]",a.parent()).removeClass(r.checkedClass)}),e.css({position:"absolute",top:"-200px",left:"-200px"}).before(a),a.parent().css("overflow","hidden")})}}();
...
/* sitelte.js */window.retrieveCalendar=function(e){var n=$("#apiURLprefix").text(),o=n+"appointments/fc_retrieveEvents";o=buildUrl(o,"UID",e),o=buildUrl(o,"serviceAccommodatorId",window.saslData.serviceAccommodatorId),o=buildUrl(o,"serviceLocationId",window.saslData.serviceLocationId),$("#calendar").fullCalendar({contentHeight:475,displayEventTime:!1,displayEventEnd:!1,minTime:"09:00:00",maxTime:"17:00:00",header:{left:"title",right:"prev,next today",center:null},views:{agendaDay:{titleFormat:"MMM D 'YY",allDaySlot:!1}},defaultView:"agendaDay",editable:!1,eventLimit:!0,eventClick:function(e,n,o){("undefined"==typeof e.cmtyx||"NOT_AVAILABLE"!==e.cmtyx)&&$.ajax({url:e.apiURL,data:"",type:"PUT",dataType:"json",success:function(e){$("#calendarSuccess").html("Success"),$("#calendarSuccess").slideDown("slow"),setTimeout(function(){$("#calendarSuccess").slideUp()},2e3),e.success===!0?$("#calendar").fullCalendar("refetchEvents"):($("#calendarWarning").html("Error:"+e.explanation),$("#calendarWarning").slideDown("slow"),setTimeout(function(){$("#calendarWarning").slideUp()},2e3))},error:function(e,n,o){$("#calendarSuccess").hide(),$("#calendarLoading").hide();var i="Service unavailable";if("undefined"!=typeof e)try{var t=JSON.parse(e.responseText);i=t.error.message}catch(n){i="Service unavailable"}else i=e.responseText;$("#calendarWarning").html("Error:"+i),$("#calendarWarning").slideDown("slow"),setTimeout(function(){$("#calendarWarning").slideUp()},5e3)}})},events:{url:o,error:function(e,n,o){$("#calendarSuccess").hide(),$("#calendarLoading").hide();var i="Service not available";if("undefined"!=typeof e.error)try{var t=JSON.parse(e.responseText);i=t.error.message}catch(a){i="Service unavailable"}else i=e.responseText;$("#calendarWarning").html("Error:"+i),$("#calendarWarning").slideDown("slow"),$("#calendar").slideUp("slow")},success:function(e){$("#calendarLoading").slideUp("slow")}}})},window.createAnonymousUser=function(e){var n=$("#apiURLprefix").text(),o=n+"authentication/registerAnonymousAdhocMember";o=buildUrl(o,"serviceAccommodatorId",window.saslData.serviceAccommodatorId),o=buildUrl(o,"serviceLocationId",window.saslData.serviceLocationId),console.log(o),$.post(o,function(e){"undefined"!=typeof e.uid&&(console.log(" saving to local storage cmxUID:"+e.uid),localStorage.setItem("cmxUID",e.uid),window.require(["actions/sessionActions"],function(n){n.setUser(e.uid,e.userName)}),window.updateLoyaltyStatus(e.uid),window.retrieveCalendar(e.uid))},"json").fail(function(e){console.log("2. error in API call"+e)})},window.attachSharingButtons=function(){$("#sms_button").click(function(){$("#sms_input_block").slideToggle("1000"),$("#sms_input").val("").focus()}),$("#sms_send_button").click(function(){var e=$("#apiURLprefix").text(),n=e+"html/sendAppURLForSASLToMobileviaSMS";n=buildUrl(n,"UID","user.anonymous"),n=buildUrl(n,"serviceAccommodatorId",window.saslData.serviceAccommodatorId),n=buildUrl(n,"serviceLocationId",window.saslData.serviceLocationId),n=buildUrl(n,"toTelephoneNumber",$("#sms_input").val()),$("#sms_input_block").slideUp("1000"),$("#sms_sendResults").slideDown("1000").html("Sending message...");var o=$.ajax({headers:{Accept:"application/json;charset=utf-8"},type:"GET",url:n,contentType:"application/json;charset=utf-8",dataType:"json",timeout:3e3});o.done(function(e){console.log("results:"+e),$("#sms_sendResults").slideDown("1000").html(e.explanation)}),o.fail(function(e,n){var o="Operation failed";"timeout"===n?o="Service Unavailable":"undefined"!=typeof e.responseJSON&&"undefined"!=typeof e.responseJSON.error&&(o=e.responseJSON.error.message),$("#sms_sendResults").slideDown("1000").html(o)}),o.always(function(){setTimeout(function(){$("#sms_sendResults").slideUp("1000")},4e3)})}),$(".phone_us").mask("(000) 000-0000")},window.openCustomURLinIFrame=function(e){var n=document.documentElement,o=document.createElement("IFRAME");o.setAttribute("src",e),n.appendChild(o),o.parentNode.removeChild(o)},window.iosJavascriptLogin=function(e,n,o,i){var t="js2ios://community_login";t=t+"?functionName="+e,console.log("url being invoked:"+t),openCustomURLinIFrame(t)},window.IOSLoginSucceeded=function(e,n){console.login("IOSloginSucceeded:"+e+", "+n),require(["actions/sessionActions"],function(o){o.setUser(e,n)})};var buildUrl=function(e,n,o){var i=e.indexOf("?")>-1?"&":"?";return e+i+n+"="+o};window.updateLoyaltyStatus=function(e){var n=$("#apiURLprefix").text(),o=n+"retail/retrieveLoyaltyStatus";o=buildUrl(o,"UID",e),o=buildUrl(o,"serviceAccommodatorId",window.saslData.serviceAccommodatorId),o=buildUrl(o,"serviceLocationId",window.saslData.serviceLocationId),console.log(o),$.get(o,function(e){e.hasLoyaltyProgram&&($("#loyaltyLine1").text(e.loyaltyBlockLine1),$("#loyaltyLine2").text(e.loyaltyBlockLine2),$("#loyaltyLine3").text(e.loyaltyBlockLine3)),$("#qrCodePlaceholder").hide(),$("#qrCodeBlock").show(),$("#qrCodeImage").empty(),$("#qrCodeImage").prepend('<img id="theQRCodeImage" src='+e.qrcodeURL+" />"),$("#qrCodeBlockLine1").text(e.qrCodeBlockLine1),$("#qrCodeBlockLine2").text(e.qrCodeBlockLine2),$("#qrCodeBlockLine3").text(e.qrCodeBlockLine3)},"json")},$(document).ready(function(){if("undefined"!=typeof $("#apiURLprefix").get(0)){var e=localStorage.getItem("cmxUID");"undefined"!=typeof e&&null!==e?(window.updateLoyaltyStatus(e),window.retrieveCalendar(e)):(console.log("1. NO cmxUID, try to create one"),window.createAnonymousUser(),console.log("anonymous user created")),window.attachSharingButtons()}else console.log("no api url")});