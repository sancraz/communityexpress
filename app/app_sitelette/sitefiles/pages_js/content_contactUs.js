...
function showEmailSuccessMessage(messageToShow){
...
function attachBootstrapValidatorsToContactUsForm() {
 ...
 .on(
   ...
   function() {
    ...
    $('#contactUsForm').formValidation('enableFieldValidators', 'message',
      !isEmpty);
    ...
    $.ajax({
     ...
     if (typeof result !== 'undefined') {
      if (result.success === true) {
        ...
        * OK
        */
       showEmailSuccessMessage(result.explanation);
     ...
     showEmailErrorMessage(extractedErrorMessage);
